...
'Pages and Posts in Feed' is a simple plugin that modifies WordPress RSS feeds to include both 'Page' and 'Post' types in the site's feed. Useful for those who use WordPress as a CMS.
